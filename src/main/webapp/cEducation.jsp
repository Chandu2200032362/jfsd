    ...
    <div class="container">
        ...
        <%
            ...
            if (request.getMethod().equalsIgnoreCase("POST")) {
                ...
                if (email.equalsIgnoreCase("educationcz@gmail.com")) {
                    try {
                ...
                if (water.equalsIgnoreCase("Education")||water.equalsIgnoreCase("education")) {
                    try {
                    ...
                    message = "Invalid Problem. Please use education";
                    messageClass = "error";
                }
            }
        %>
        ...
        <form id="problemForm" method="post">
            ...
            <input type="text" id="T4" name="water" placeholder="Only Education" required>

            <label for="email">Email</label>
            <input type="email" id="T3" name="email" placeholder="Only Use educationcz@gmail.com" required>
