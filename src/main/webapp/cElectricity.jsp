    ...
    <div class="container">
        ...
        <%
            ...
            if (request.getMethod().equalsIgnoreCase("POST")) {
                ...
                if (email.equalsIgnoreCase("electricitycz@gmail.com")) {
                    try {
                ...
                if (water.equalsIgnoreCase("Electricity")||water.equalsIgnoreCase("electricity")) {
                    try {
                    ...
                    message = "Invalid Problem. Please use Electricity	.";
                    messageClass = "error";
                }
            }
        %>
        ...
        <form id="problemForm" method="post">
            ...
            <input type="text" id="T4" name="water" placeholder="Only Electricity" required>

            <label for="email">Email</label>
            <input type="email" id="T3" name="email" placeholder="Only Use electricitycz@gmail.com" required>
