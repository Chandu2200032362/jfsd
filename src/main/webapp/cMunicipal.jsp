    ...
    <div class="container">
        ...
        <%
            ...
            if (request.getMethod().equalsIgnoreCase("POST")) {
                ...
                if (email.equalsIgnoreCase("municipalcz@gmail.com")) {
                    try {
                ...
                if (water.equalsIgnoreCase("Municipal")||water.equalsIgnoreCase("municipal")) {
                    try {
                    ...
                    message = "Invalid Problem. Please use Municipal	.";
                    messageClass = "error";
                }
            }
        %>
        ...
        <form id="problemForm" method="post">
            ...
            <input type="text" id="T4" name="water" placeholder="Only Municipal" required>

            <label for="email">Email</label>
            <input type="email" id="T3" name="email" placeholder="Only Use municipalcz@gmail.com" required>
