    ...
    <div class="container">
        ...
        <%
            ...
            if (request.getMethod().equalsIgnoreCase("POST")) {
                ...
                if (email.equalsIgnoreCase("agriculturecz@gmail.com")) {
                    try {
                ...
                if (water.equalsIgnoreCase("Agriculture")||water.equalsIgnoreCase("agriculture")) {
                    try {
                    ...
                    message = "Invalid Problem. Please use Agriculture	.";
                    messageClass = "error";
                }
            }
        %>
        ...
        <form id="problemForm" method="post">
            ...
            <input type="text" id="T4" name="water" placeholder="Only Agriculture" required>

            <label for="email">Email</label>
            <input type="email" id="T3" name="email" placeholder="Only Use agriculturecz@gmail.com" required>
